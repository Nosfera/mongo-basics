...
2. MongoDB
  1. Create a DB
  2. Select DB 
  3. Create a collection with name task
  4. [check](http://mongodb.github.io/node-mongodb-native/2.2/quick-start/quick-start/)
...
*FYI:* 
[PUMPmyREADMEmarkdown](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)
